...
assert (
    result["material_certificate_history"][
        "action"
    ]
    == "REPLACE_CURRENT"
)
...
assert (
    superseded_primary[0]["cert_org"]
    == "MUIS"
)

assert (
    superseded_primary[0]["cert_no"]
    == "PRN22020011873"
)
...
confirmed = (
    workflow.get_confirmed_history_for_job(
        JOB_ID
    )
)
...
print("REPLACE_CURRENT_INTEGRATION_TEST_OK")
